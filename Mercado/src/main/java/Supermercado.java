...
public class Supermercado {
    ...
    //Método buscar producto por codigo
    ...
    public void actualizarInventarioVenta(String codigoProducto, int cantidadVendida) {
        Producto producto = buscarProductoPorCodigo(codigoProducto);
        if (producto != null) {
            // Delegación: El supermercado no resta directamente, le ordena al Producto que lo haga
            producto.actualizarInventario(cantidadVendida);
        }
    }
